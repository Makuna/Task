...
public:
    ...
    void Loop(uint8_t sleepMode = SLEEP_MODE_IDLE, uint8_t watchdogTimeOutFlag = WDTO_500MS);
...
private:
    ...
    void WatchDogWakeupSleep(uint8_t sleepMode, uint32_t nextWakeTimeMs, uint8_t watchdogTimeOutFlag);
};
